...
Route::middleware(['auth'])->prefix('inventory-manager')->group(function () {
    ...
    // Route::get("/materials", [InventoryController::class, 'materials'])->name('inventory.materials');
    ...
    // Route::get("/suppliers", [InventoryController::class, 'suppliers'])->name('inventory.suppliers');
