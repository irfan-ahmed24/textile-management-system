...
function Registration() {
    ...
    return (
        <div className="min-h-screen bg-[#080B11] flex items-center justify-center p-6 py-20 relative overflow-hidden">
            ...
            {/* Container: ডেস্কটপে সুন্দর দেখানোর জন্য max-width সেট করা হয়েছে */}
            <div className="w-full lg:max-w-[700px] relative z-10">
                ...
                >
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <button
                            disabled={processing}
                            className="w-full bg-blue-600 text-white py-4 rounded-2xl font-black text-lg shadow-lg shadow-blue-600/20 hover:bg-blue-700 hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-3 mt-4 disabled:opacity-50"
                        >
                            Apply for Account <Send size={20} />
                        </button>
                    </form>
