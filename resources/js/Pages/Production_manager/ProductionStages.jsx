...
function ProductionStages({ dbOrders = [], dbStages = [] }) {
    const [searchId, setSearchId] = useState("");

    // ইনপুট চেঞ্জ হওয়ার সাথে সাথে ডাটাবেস থেকে আসা অর্ডারের মধ্যে সার্চ করা হচ্ছে
    const activeOrder = dbOrders.find((o) => o.id === searchId);

    // আইকন ম্যাপার
    const getIconByStage = (stageId) => {
        const iconMap = {
            0: "GitGraph",
            1: "Wind",
            2: "Droplets",
            ...
            <div className="p-6 max-w-[1400px] mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
                    ...
                    <div className="relative w-full md:w-96 group">
                        ...
                        <input
                            type="text"
                            placeholder="Type Order ID (e.g. 1, 2, 5)..."
                            value={searchId}
                ...
                {/* --- Order Info Section (Now on Top) --- */}
                <motion.div
                    layout
                    className="mb-12 p-8 bg-white/[0.02] border border-white/5 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl"
                >
                    ...
                    {activeOrder && (
                        <motion.div
                            ...
                            className="bg-black/40 px-8 py-4 rounded-2xl border border-white/5"
                        >
